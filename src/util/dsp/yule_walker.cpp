...
/**
*
*	@brief - This is a simple solver for Yule-Walker equations using a specialized version of the Levinson-Durbin algorithm.
*
*	@param size[in] - the size of the Toeplitz matrix and of result vector sigmaAndCoeffs
*	@param acov[in] - a buffer containing the covariance coefficents for indices 0 to (size-1). ie. [acov(0) acov(1) ... acov(n-1)] of length (size)
*	@param sigmaAndCoeffs[out] - result vector of length (size). The first element will be the variance of the signal, and the remaining elements will be the estimated coefficients of the autoregressive filter.
*	@param scratchBuffer - a block of memory used to hold intermediate computations. You must pass a buffer of size at least (2 * size * sizeof(float)).
*
*/

...
BiquadSoftReset<Tv,Tp,Td>::BiquadSoftReset(Tp frq, Tp res, gam::FilterType type)
...
template <class Tv, class Tp, class Td>
Tp BiquadSoftReset<Tv,Tp,Td>::freq() const { return mFreq; }

template <class Tv, class Tp, class Td>
Tp BiquadSoftReset<Tv,Tp,Td>::res() const { return Tp(0.5)/mResRecip; }

template <class Tv, class Tp, class Td>
Tp BiquadSoftReset<Tv,Tp,Td>::level() const { return mLevel; }

template <class Tv, class Tp, class Td>
gam::FilterType BiquadSoftReset<Tv,Tp,Td>::type() const { return mType; }
...
template <class Tv, class Tp, class Td>
inline void BiquadSoftReset<Tv,Tp,Td>::set(Tp frq, Tp res){ set(frq, res, mType); }
...
inline void BiquadSoftReset<Tv,Tp,Td>::resRecip(Tp v){
  ...
  switch(mType){
    case gam::LOW_SHELF: case gam::HIGH_SHELF: break; // coefs computed in type()
    default:

...
namespace otto::engines {
    ...
    struct ExampleFXScreen : EngineScreen<ExampleFX> {
        ...
        using EngineScreen<ExampleFX>::EngineScreen;
    };

    ExampleFX::ExampleFX() : EffectEngine<ExampleFX>(std::make_unique<ExampleFXScreen>(this))
    {
      ...
      props.flt_freq.on_change().connect([this](float f) {
    ...
    audio::ProcessData<2> ExampleFX::process(audio::ProcessData<1> data)
    {
    ...
    void ExampleFXScreen::encoder(ui::EncoderEvent ev)
    {
    ...
    bool ExampleFXScreen::keypress(ui::Key key)
    {
      return false;
    }

    void ExampleFXScreen::draw(ui::vg::Canvas& ctx)
    {
      using namespace ui::vg;

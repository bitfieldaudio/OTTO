...
with {
  ...
  //ADSR envelope----------------------------
  envelope = en.adsre(a,d,s,r,midigate)*(midigain * 10);
  a = hslider("/v:envelope/Attack", 0.001, 0.001, 4, 0.001);
  d = hslider("/v:envelope/Decay", 0, 0, 4, 0.01);
  s = hslider("/v:envelope/Sustain", 1, 0, 1, 0.1) * 100;
  r = hslider("/v:envelope/Release", 0, 0, 4, 0.01);
};

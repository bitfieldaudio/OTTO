...
class faust_nuke : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow7 = (100.0f * (fSlow6 * float(iSlow1)));
		...
		float fSlow41 = (100.0f * (fSlow6 * float(iSlow40)));
		...
		float fSlow71 = (100.0f * (fSlow6 * float(iSlow70)));
		...
		float fSlow101 = (100.0f * (fSlow6 * float(iSlow100)));
		...
		float fSlow131 = (100.0f * (fSlow6 * float(iSlow130)));
		...
		float fSlow161 = (100.0f * (fSlow6 * float(iSlow160)));

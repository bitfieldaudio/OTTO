...
class faust_nuke : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow12 = std::max((0.5f * fSlow11), 23.4489498f);
		float fSlow13 = std::max(20.0f, std::fabs(fSlow12));
		float fSlow14 = (fConst2 / fSlow13);
		float fSlow15 = (fConst0 / fSlow12);
		float fSlow16 = (fConst4 * fSlow11);
		float fSlow17 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow12)));
		...
		float fSlow29 = std::max(fSlow11, 23.4489498f);
		float fSlow30 = std::max(20.0f, std::fabs(fSlow29));
		float fSlow31 = (fConst2 / fSlow30);
		float fSlow32 = (fConst0 / fSlow29);
		float fSlow33 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow29)));
		...
		float fSlow45 = std::max((0.5f * fSlow44), 23.4489498f);
		float fSlow46 = std::max(20.0f, std::fabs(fSlow45));
		float fSlow47 = (fConst2 / fSlow46);
		float fSlow48 = (fConst0 / fSlow45);
		float fSlow49 = (fConst4 * fSlow44);
		float fSlow50 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow45)));
		...
		float fSlow61 = std::max(fSlow44, 23.4489498f);
		float fSlow62 = std::max(20.0f, std::fabs(fSlow61));
		float fSlow63 = (fConst2 / fSlow62);
		float fSlow64 = (fConst0 / fSlow61);
		float fSlow65 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow61)));
		...
		float fSlow76 = std::max((0.5f * fSlow75), 23.4489498f);
		float fSlow77 = std::max(20.0f, std::fabs(fSlow76));
		float fSlow78 = (fConst2 / fSlow77);
		float fSlow79 = (fConst0 / fSlow76);
		float fSlow80 = (fConst4 * fSlow75);
		float fSlow81 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow76)));
		...
		float fSlow92 = std::max(fSlow75, 23.4489498f);
		float fSlow93 = std::max(20.0f, std::fabs(fSlow92));
		float fSlow94 = (fConst2 / fSlow93);
		float fSlow95 = (fConst0 / fSlow92);
		float fSlow96 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow92)));
		...
		float fSlow107 = std::max((0.5f * fSlow106), 23.4489498f);
		float fSlow108 = std::max(20.0f, std::fabs(fSlow107));
		float fSlow109 = (fConst2 / fSlow108);
		float fSlow110 = (fConst0 / fSlow107);
		float fSlow111 = (fConst4 * fSlow106);
		float fSlow112 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow107)));
		...
		float fSlow123 = std::max(fSlow106, 23.4489498f);
		float fSlow124 = std::max(20.0f, std::fabs(fSlow123));
		float fSlow125 = (fConst2 / fSlow124);
		float fSlow126 = (fConst0 / fSlow123);
		float fSlow127 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow123)));
		...
		float fSlow138 = std::max((0.5f * fSlow137), 23.4489498f);
		float fSlow139 = std::max(20.0f, std::fabs(fSlow138));
		float fSlow140 = (fConst2 / fSlow139);
		float fSlow141 = (fConst0 / fSlow138);
		float fSlow142 = (fConst4 * fSlow137);
		float fSlow143 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow138)));
		...
		float fSlow154 = std::max(fSlow137, 23.4489498f);
		float fSlow155 = std::max(20.0f, std::fabs(fSlow154));
		float fSlow156 = (fConst2 / fSlow155);
		float fSlow157 = (fConst0 / fSlow154);
		float fSlow158 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow154)));
		...
		float fSlow169 = std::max((0.5f * fSlow168), 23.4489498f);
		float fSlow170 = std::max(20.0f, std::fabs(fSlow169));
		float fSlow171 = (fConst2 / fSlow170);
		float fSlow172 = (fConst0 / fSlow169);
		float fSlow173 = (fConst4 * fSlow168);
		float fSlow174 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow169)));
		...
		float fSlow185 = std::max(fSlow168, 23.4489498f);
		float fSlow186 = std::max(20.0f, std::fabs(fSlow185));
		float fSlow187 = (fConst2 / fSlow186);
		float fSlow188 = (fConst0 / fSlow185);
		float fSlow189 = std::max(0.0f, std::min(2047.0f, (fConst5 / fSlow185)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp8 = std::max(0.0f, std::min(2047.0f, (fSlow15 * fTemp7)));
			...
			fVec6[0] = fTemp22;
			float fTemp23 = std::max((fSlow11 * fTemp19), 23.4489498f);
			...
			fVec10[0] = fTemp37;
			float fTemp38 = std::max((fSlow11 * fTemp34), 23.4489498f);
			...
			float fTemp62 = std::max(0.0f, std::min(2047.0f, (fSlow32 * fTemp7)));
			...
			float fTemp78 = std::max(0.0f, std::min(2047.0f, (fSlow48 * fTemp7)));
			...
			fVec22[0] = fTemp84;
			float fTemp85 = std::max((fSlow44 * fTemp19), 23.4489498f);
			...
			fVec26[0] = fTemp95;
			float fTemp96 = std::max((fSlow44 * fTemp34), 23.4489498f);
			...
			float fTemp116 = std::max(0.0f, std::min(2047.0f, (fSlow64 * fTemp7)));
			...
			float fTemp126 = std::max(0.0f, std::min(2047.0f, (fSlow79 * fTemp7)));
			...
			fVec38[0] = fTemp132;
			float fTemp133 = std::max((fSlow75 * fTemp19), 23.4489498f);
			...
			fVec42[0] = fTemp143;
			float fTemp144 = std::max((fSlow75 * fTemp34), 23.4489498f);
			...
			float fTemp164 = std::max(0.0f, std::min(2047.0f, (fSlow95 * fTemp7)));
			...
			float fTemp174 = std::max(0.0f, std::min(2047.0f, (fSlow110 * fTemp7)));
			...
			fVec54[0] = fTemp180;
			float fTemp181 = std::max((fSlow106 * fTemp19), 23.4489498f);
			...
			fVec58[0] = fTemp191;
			float fTemp192 = std::max((fSlow106 * fTemp34), 23.4489498f);
			...
			float fTemp212 = std::max(0.0f, std::min(2047.0f, (fSlow126 * fTemp7)));
			...
			float fTemp222 = std::max(0.0f, std::min(2047.0f, (fSlow141 * fTemp7)));
			...
			fVec70[0] = fTemp228;
			float fTemp229 = std::max((fSlow137 * fTemp19), 23.4489498f);
			...
			fVec74[0] = fTemp239;
			float fTemp240 = std::max((fSlow137 * fTemp34), 23.4489498f);
			...
			float fTemp260 = std::max(0.0f, std::min(2047.0f, (fSlow157 * fTemp7)));
			...
			float fTemp270 = std::max(0.0f, std::min(2047.0f, (fSlow172 * fTemp7)));
			...
			fVec86[0] = fTemp276;
			float fTemp277 = std::max((fSlow168 * fTemp19), 23.4489498f);
			...
			fVec90[0] = fTemp287;
			float fTemp288 = std::max((fSlow168 * fTemp34), 23.4489498f);
			...
			float fTemp308 = std::max(0.0f, std::min(2047.0f, (fSlow188 * fTemp7)));
			...
			output0[i] = FAUSTFLOAT((((((((fSlow0 * (std::min(1.0f, fRec0[0]) * ((fRec2[1] + (0.5f * fRec2[0])) + (0.5f * fRec2[2])))) + (fSlow41 * (std::min(1.0f, fRec24[0]) * ((fRec26[1] + (0.5f * fRec26[0])) + (0.5f * fRec26[2]))))) + (fSlow72 * (std::min(1.0f, fRec44[0]) * ((fRec46[1] + (0.5f * fRec46[0])) + (0.5f * fRec46[2]))))) + (fSlow103 * (std::min(1.0f, fRec64[0]) * ((fRec66[1] + (0.5f * fRec66[0])) + (0.5f * fRec66[2]))))) + (fSlow134 * (std::min(1.0f, fRec84[0]) * ((fRec86[1] + (0.5f * fRec86[0])) + (0.5f * fRec86[2]))))) + (fSlow165 * (std::min(1.0f, fRec104[0]) * ((fRec106[1] + (0.5f * fRec106[0])) + (0.5f * fRec106[2]))))) / fTemp72));
			iVec0[1] = iVec0[0];
			iRec1[1] = iRec1[0];
			fRec0[1] = fRec0[0];
			fRec4[1] = fRec4[0];

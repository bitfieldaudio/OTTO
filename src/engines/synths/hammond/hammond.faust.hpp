  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fTempPerm4 = (fRec8[1] + (fConst10 * fRec2[0]));
			...
			fRec0[0] = ((0.5f * ((((ftbl0[int((65536.0f * fRec14[0]))] + (fRec13[0] * ftbl0[int((65536.0f * fRec12[0]))])) + (fRec11[0] * ftbl0[int((65536.0f * fRec10[0]))])) + (fRec9[0] * ftbl0[int((65536.0f * fRec7[0]))])) + (fConst8 * ((fRec2[0] * fRec5[0]) * fTempPerm2)))) - (fConst7 * ((fConst6 * fRec0[2]) + (fConst4 * fRec0[1]))));
			fTempPerm10 = ((0.5f * fTempPerm5) + 1.0f);
			iRec16[0] = (iSlow15 * (iRec16[1] + 1));
			iTempPerm11 = int((iRec16[0] < iSlow14));
			fTempPerm12 = expf((0 - (fConst16 / ((iSlow16)?((iTempPerm11)?fSlow13:fSlow11):fSlow10))));
			...
			fRec17[0] = ((0.5f * ((((ftbl0[int((65536.0f * fRec22[0]))] + (fRec13[0] * ftbl0[int((65536.0f * fRec21[0]))])) + (fRec11[0] * ftbl0[int((65536.0f * fRec20[0]))])) + (fRec9[0] * ftbl0[int((65536.0f * fRec19[0]))])) + (fConst8 * ((fRec2[0] * fRec18[0]) * fTempPerm2)))) - (fConst7 * ((fConst6 * fRec17[2]) + (fConst4 * fRec17[1]))));
			iRec24[0] = (iSlow26 * (iRec24[1] + 1));
			iTempPerm16 = int((iRec24[0] < iSlow14));
			fTempPerm17 = expf((0 - (fConst16 / ((iSlow27)?((iTempPerm16)?fSlow13:fSlow11):fSlow10))));
			...
			fRec25[0] = ((0.5f * ((((ftbl0[int((65536.0f * fRec30[0]))] + (fRec13[0] * ftbl0[int((65536.0f * fRec29[0]))])) + (fRec11[0] * ftbl0[int((65536.0f * fRec28[0]))])) + (fRec9[0] * ftbl0[int((65536.0f * fRec27[0]))])) + (fConst8 * ((fRec2[0] * fRec26[0]) * fTempPerm2)))) - (fConst7 * ((fConst6 * fRec25[2]) + (fConst4 * fRec25[1]))));
			iRec32[0] = (iSlow36 * (iRec32[1] + 1));
			iTempPerm21 = int((iRec32[0] < iSlow14));
			fTempPerm22 = expf((0 - (fConst16 / ((iSlow37)?((iTempPerm21)?fSlow13:fSlow11):fSlow10))));
			...
			fRec33[0] = ((0.5f * ((((ftbl0[int((65536.0f * fRec38[0]))] + (fRec13[0] * ftbl0[int((65536.0f * fRec37[0]))])) + (fRec11[0] * ftbl0[int((65536.0f * fRec36[0]))])) + (fRec9[0] * ftbl0[int((65536.0f * fRec35[0]))])) + (fConst8 * ((fRec2[0] * fRec34[0]) * fTempPerm2)))) - (fConst7 * ((fConst6 * fRec33[2]) + (fConst4 * fRec33[1]))));
			iRec40[0] = (iSlow46 * (iRec40[1] + 1));
			iTempPerm26 = int((iRec40[0] < iSlow14));
			fTempPerm27 = expf((0 - (fConst16 / ((iSlow47)?((iTempPerm26)?fSlow13:fSlow11):fSlow10))));
			...
			fRec41[0] = ((0.5f * ((((ftbl0[int((65536.0f * fRec46[0]))] + (fRec13[0] * ftbl0[int((65536.0f * fRec45[0]))])) + (fRec11[0] * ftbl0[int((65536.0f * fRec44[0]))])) + (fRec9[0] * ftbl0[int((65536.0f * fRec43[0]))])) + (fConst8 * ((fRec2[0] * fRec42[0]) * fTempPerm2)))) - (fConst7 * ((fConst6 * fRec41[2]) + (fConst4 * fRec41[1]))));
			iRec48[0] = (iSlow56 * (iRec48[1] + 1));
			iTempPerm31 = int((iRec48[0] < iSlow14));
			fTempPerm32 = expf((0 - (fConst16 / ((iSlow57)?((iTempPerm31)?fSlow13:fSlow11):fSlow10))));
			...
			fRec49[0] = ((0.5f * ((((ftbl0[int((65536.0f * fRec54[0]))] + (fRec13[0] * ftbl0[int((65536.0f * fRec53[0]))])) + (fRec11[0] * ftbl0[int((65536.0f * fRec52[0]))])) + (fRec9[0] * ftbl0[int((65536.0f * fRec51[0]))])) + (fConst8 * ((fRec2[0] * fRec50[0]) * fTempPerm2)))) - (fConst7 * ((fConst6 * fRec49[2]) + (fConst4 * fRec49[1]))));
			iRec56[0] = (iSlow66 * (iRec56[1] + 1));
			iTempPerm36 = int((iRec56[0] < iSlow14));
			fTempPerm37 = expf((0 - (fConst16 / ((iSlow67)?((iTempPerm36)?fSlow13:fSlow11):fSlow10))));
			fRec55[0] = ((fRec55[1] * fTempPerm37) + (((iSlow67)?((iTempPerm36)?1.5873015873015872f:fSlow68):0.0f) * (1.0f - fTempPerm37)));
			output0[i] = (FAUSTFLOAT)(fConst7 * ((((((fSlow69 * (min(1.0f, fRec55[0]) * (((fRec49[2] + (fRec49[0] + (2.0f * fRec49[1]))) * fTempPerm10) + (((fConst3 * fRec49[0]) + (fConst15 * fRec49[1])) + (fConst3 * fRec49[2]))))) + (fSlow59 * (min(1.0f, fRec47[0]) * ((fTempPerm10 * (fRec41[2] + (fRec41[0] + (2.0f * fRec41[1])))) + (((fConst3 * fRec41[0]) + (fConst15 * fRec41[1])) + (fConst3 * fRec41[2])))))) + (fSlow49 * (min(1.0f, fRec39[0]) * ((fTempPerm10 * (fRec33[2] + (fRec33[0] + (2.0f * fRec33[1])))) + (((fConst3 * fRec33[0]) + (fConst15 * fRec33[1])) + (fConst3 * fRec33[2])))))) + (fSlow39 * (min(1.0f, fRec31[0]) * ((fTempPerm10 * (fRec25[2] + (fRec25[0] + (2.0f * fRec25[1])))) + (((fConst3 * fRec25[0]) + (fConst15 * fRec25[1])) + (fConst3 * fRec25[2])))))) + (fSlow29 * (min(1.0f, fRec23[0]) * ((fTempPerm10 * (fRec17[2] + (fRec17[0] + (2.0f * fRec17[1])))) + (((fConst3 * fRec17[0]) + (fConst15 * fRec17[1])) + (fConst3 * fRec17[2])))))) + (fSlow19 * (min(1.0f, fRec15[0]) * ((fTempPerm10 * (fRec0[2] + (fRec0[0] + (2.0f * fRec0[1])))) + (((fConst3 * fRec0[0]) + (fConst15 * fRec0[1])) + (fConst3 * fRec0[2])))))));
			// post processing
			fRec55[1] = fRec55[0];
			iRec56[1] = iRec56[0];

...
namespace otto::engines::nuke {
  ...
  void FourParams::do_draw(skia::Canvas& ctx)
  {
    ...
    skia::place_text(ctx, "Param 0", fonts::regular(24), colors::blue, {0, spacing}, anchors::top_left);
    skia::place_text(ctx, fmt::format("{:1.2}", a), fonts::regular(24), colors::blue, {width, spacing},
                     anchors::top_right);

    skia::place_text(ctx, "Param 1", fonts::regular(24), colors::green, {0, 2 * spacing}, anchors::top_left);
    skia::place_text(ctx, fmt::format("{:1.2}", b), fonts::regular(24), colors::green, {width, 2 * spacing},
                     anchors::top_right);

    skia::place_text(ctx, "Param 2", fonts::regular(24), colors::yellow, {0, 3 * spacing}, anchors::top_left);
    skia::place_text(ctx, fmt::format("{:1.2}", c), fonts::regular(24), colors::yellow, {width, 3 * spacing},
                     anchors::top_right);

    skia::place_text(ctx, "Param 3", fonts::regular(24), colors::red, {0, 4 * spacing}, anchors::top_left);

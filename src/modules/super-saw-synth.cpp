...
#include "super-saw-synth.faust.h"
...
void SuperSawSynth::process(uint nframes) {
...
// Main drawing method
void SuperSawSynthScreen::draw(drawing::Canvas& ctx) {
  using namespace ui;

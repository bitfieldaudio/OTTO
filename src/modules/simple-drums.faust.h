 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp5 = (fRec1[1] + (fConst1 * fTemp4));
			...
			float fTemp11 = ((fSlow12 * ((fTemp7 - (fVec3[((IOTA - iTemp9) & 4095)] * (fTemp10 + (1.0f - fTemp8)))) - ((fTemp8 - fTemp10) * fVec3[((IOTA - (iTemp9 + 1)) & 4095)]))) + (fSlow18 * float(iRec3[0])));
			fRec6[0] = (iTemp0?0.0f:min(fSlow29, (fRec6[1] + 1.0f)));
			...
			float fTemp21 = ((fSlow25 * ((fTemp17 - (fVec5[((IOTA - iTemp19) & 4095)] * (fTemp20 + (1.0f - fTemp18)))) - ((fTemp18 - fTemp20) * fVec5[((IOTA - (iTemp19 + 1)) & 4095)]))) + (fSlow31 * float(iRec3[0])));

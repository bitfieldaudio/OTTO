...
namespace otto::nvg {
  ...
  struct Font {
     ...
     */
    Font(Canvas& canvas, const std::string& fname, const std::string& ttfPath);
     ...
     */
    Font(Canvas& canvas, const std::string& fname, const Memery& mem, bool invalidateMem);

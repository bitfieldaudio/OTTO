...
public:
    Agent_adaptor()
    : ::DBus::InterfaceAdaptor("net.connman.Agent")
    {
    ...
    {
        static const ::DBus::IntrospectedArgument Release_args[] =
        {
            { 0, 0, 0 }
        };
        ...
        static const ::DBus::IntrospectedMethod Agent_adaptor_methods[] =
        {
        ...
        static const ::DBus::IntrospectedMethod Agent_adaptor_signals[] =
        {
            { 0, 0 }
        };
        static const ::DBus::IntrospectedProperty Agent_adaptor_properties[] =
        {
            { 0, 0, 0, 0 }
        };
        ...
        {
            "net.connman.Agent",
            Agent_adaptor_methods,
            Agent_adaptor_signals,
            Agent_adaptor_properties
        };
    ...
    virtual std::map< std::string, ::DBus::Variant > RequestInput(const ::DBus::Path& argin0, const std::map< std::string, ::DBus::Variant >& argin1, ::DBus::Error &error) = 0;
...
private:
    ...
    ::DBus::Message _ReportError_stub(const ::DBus::CallMessage &__call)
    {
        ...
        ::DBus::Path argin0; __ri >> argin0;
        std::string argin1; __ri >> argin1;
    ...
    ::DBus::Message _RequestInput_stub(const ::DBus::CallMessage &__call)
    {
        ...
        ::DBus::MessageIter __ri = __call.reader();
        ::DBus::Path argin0; __ri >> argin0;
        std::map< std::string, ::DBus::Variant > argin1; __ri >> argin1;

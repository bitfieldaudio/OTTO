...
TEST_CASE ("UIManager") {
  ...
  SUBCASE ("Seq keys -> midi events") {
    ...
    REQUIRE(midi_handler.events == Events{
                                     midi::NoteOn{.channel = 0, .note = 52, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 53, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 54, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 55, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 56, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 57, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 58, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 59, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 60, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 61, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 62, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 63, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 64, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 65, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 66, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 67, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 68, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 69, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 70, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 71, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 72, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 73, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 74, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 75, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 76, .velocity = 0x40},
                                     midi::NoteOn{.channel = 0, .note = 77, .velocity = 0x40},
                                     midi::NoteOff{.channel = 0, .note = 52, .velocity = 0x00},
                                   });
  }
}

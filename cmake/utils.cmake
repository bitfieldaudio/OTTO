...
macro(otto_include_board BOARD)
    ...
    target_compile_definitions(otto_exec PUBLIC "OTTO_BOARD_${BOARD_DEFINITION_NAME}")
    target_include_directories(otto_exec PUBLIC ${BOARD_DIR}/include)
    
    file(GLOB_RECURSE BOARD_SOURCES ${BOARD_DIR}/src/*.cpp)
    if (NOT "${BOARD_SOURCES}" STREQUAL "") 
        target_sources(otto_exec PRIVATE ${BOARD_SOURCES})
    endif()
